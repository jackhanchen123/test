...
<body>
	...
	<div id="code"></div>
	<input type="button" id="btn" value="通过ajax加载数据"/>
	<script>
		$().ready(function(){
			$("#btn").bind("click",function(){
				$.ajax({
					url:"${pageContext.request.contextPath}/getcharts",
					type:"get",
					dataType:"json",
	...
	<input type="button" id="btn1" value="整体跳转加载数据"/>
	<script>
		$().ready(function(){
			$("#btn1").bind("click",function(){
				location.replace("${pageContext.request.contextPath}/getdata");
			});
		});
	</script>
